...
def Ks_Gillespie(doInit,N_slowK,V_m,si,it,kinParams):
    "/*		STATIC VARIABLES	*/"
    t_occ_slowK = 0
    state = -1
    ...
    assert s1 >= 0, "Illegal number of channels in open state."
    return(s0,s1)
